...
import com.parrotanalytics.metrics.service.data.repo.api.cache.CacheKeyGenerator;
import com.parrotanalytics.metrics.service.data.repo.api.cache.MetricRedisCacheManager;
...
@ComponentScan(basePackages =
    {
        "com.parrotanalytics.apicore.controllers",
        "com.parrotanalytics.apicore.config"
    })
...
public class AppConfig extends CachingConfigurerSupport implements CachingConfigurer
{
    ...
    public CacheManager cacheManager(RedisConnectionFactory redisConnectionFactory)
    {
        ...
        MetricRedisCacheManager redisCacheManager = new MetricRedisCacheManager(RedisCacheWriter.nonLockingRedisCacheWriter(redisConnectionFactory),
            defaultCacheConfig, cacheConfigurationMap);
        redisCacheManager.setTransactionAware(true);
        //RedisCacheManager cacheManager = MetricRedisCacheManager.builder(redisConnectionFactory)
