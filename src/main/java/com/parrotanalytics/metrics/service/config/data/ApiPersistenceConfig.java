 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.parrotanalytics.metrics.service.data.repo.api", entityManagerFactoryRef = "apiEntityManagerFactory", transactionManagerRef = "apiTransactionManager")
...
public class ApiPersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean apiEntityManagerFactory() {
        ...
        emfb.setPackagesToScan("com.parrotanalytics.metrics.service.apidb_model");
