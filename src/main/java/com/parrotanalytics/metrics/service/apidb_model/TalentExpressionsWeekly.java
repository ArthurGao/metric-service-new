...
@Table(name = TableConstants.TALENT_EXPRESSIONS_COMPUTED_WEEKLY, schema = TableConstants.METRICS_SCHEMA)
public class TalentExpressionsWeekly extends RDSBaseEntity
{

	private static final long serialVersionUID = -1776207400034665502L;
	...
	@Override
	public TalentExpressionsWeekly clone()
	{
