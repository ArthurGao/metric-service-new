...
import com.parrotanalytics.metrics.service.apidb_model.nonmanaged.MetadataESFilter;
import com.parrotanalytics.metrics.service.commons.gson.RuntimeTypeAdapterFactory;
...
public class CatalogESService
{
    ...
    private static String[] esTVMetricsCatalogSources = new String[] { "title",
    ...
    private static String[] esTalentMetricsCatalogSources = new String[] { "title",
    ...
    private static String[] esMovieMetricsCatalogSources = new String[] {
    ...
    protected String[] getESSources(ElasticSearchIndex esIndex, boolean fullCatalog)
    {
        switch (esIndex)
        {
            case SERIES_METADATA:
                return fullCatalog ? esTVFullCatalogSources : esTVMetricsCatalogSources;
            case TALENT_METADATA:
                return fullCatalog ? esTalentFullCatalogSources : esTalentMetricsCatalogSources;
            case MOVIE_METADATA:
                return fullCatalog ? esMovieFullCatalogSources : esMovieMetricsCatalogSources;
            default:
