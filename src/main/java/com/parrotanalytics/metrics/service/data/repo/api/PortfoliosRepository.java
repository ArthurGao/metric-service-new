...
import com.parrotanalytics.metrics.service.apidb_model.nonmanaged.PortfolioWithCount;
...
public interface PortfoliosRepository extends PagingAndSortingRepository<Portfolio, Integer>, PortfoliosRepositoryCustom
{
     ...
     * @return
     */
    @Query("SELECT NEW com.parrotanalytics.metrics.service.apidb_model.nonmanaged.PortfolioWithCount"
