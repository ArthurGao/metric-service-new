 ...
 */
@Entity
@Table(name = TableConstants.TALENT_EXPRESSIONS_COMPUTED, schema = TableConstants.METRICS_SCHEMA)
@IdClass(value = ExpressionsComputedPK.class)
public class TalentExpressionsComputed extends RDSBaseEntity
{
