...
public class DemandExpressionsMonthlyPK implements Serializable
{
    ...
    public DemandExpressionsMonthlyPK()
    {
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (getClass() != obj.getClass())
            return false;
        DemandExpressionsMonthlyPK other = (DemandExpressionsMonthlyPK) obj;
        if (country == null)
        {
