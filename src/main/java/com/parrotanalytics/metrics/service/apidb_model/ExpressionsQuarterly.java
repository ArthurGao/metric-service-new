...
@Table(name = TableConstants.EXPRESSIONS_COMPUTED_QUARTERLY, schema = TableConstants.METRICS_SCHEMA)
public class ExpressionsQuarterly extends RDSBaseEntity
{
     ...
     */
    @Override
    public ExpressionsQuarterly clone()
    {
