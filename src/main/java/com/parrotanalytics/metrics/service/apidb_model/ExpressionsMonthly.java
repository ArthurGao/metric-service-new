...
@Table(name = TableConstants.EXPRESSIONS_COMPUTED_MONTHLY, schema = TableConstants.METRICS_SCHEMA)
public class ExpressionsMonthly extends RDSBaseEntity
{
    ...
    @Override
    public ExpressionsMonthly clone()
    {
