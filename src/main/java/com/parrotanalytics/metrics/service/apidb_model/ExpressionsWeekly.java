...
@Table(name = TableConstants.EXPRESSIONS_COMPUTED_WEEKLY, schema = TableConstants.METRICS_SCHEMA)
public class ExpressionsWeekly extends RDSBaseEntity
{
    ...
    @Override
    public ExpressionsWeekly clone()
    {
