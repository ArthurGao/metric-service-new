 ...
 */
@Entity
@Table(name = TableConstants.CONSOLIDATED_CONTEXTMETRICSV2, schema = TableConstants.METRICS_SCHEMA)
@IdClass(ConsolidatedContextMetricsPKV2.class)
public class ConsolidatedContextMetricsV2 extends RDSBaseEntity
{
