...
@Entity
@Table(name = TableConstants.EXPRESSIONS_DAILY, schema = TableConstants.METRICS_SCHEMA)
@IdClass(value = ExpressionsDailyPK.class)
public class ExpressionsDaily extends RDSBaseEntity
{
