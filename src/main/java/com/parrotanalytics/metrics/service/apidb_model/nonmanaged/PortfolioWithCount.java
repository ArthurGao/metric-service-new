...
import com.parrotanalytics.metrics.service.apidb_model.IPortfolio;
        ...
        @ConstructorResult(targetClass = PortfolioWithCount.class, columns =
            {
                ...
                @ColumnResult(name = "entity", type = com.parrotanalytics.metrics.service.commons.constants.Entity.class)
            })
    })
@JsonPropertyOrder(
    {
...
public class PortfolioWithCount implements IPortfolio {
  ...
  @JsonProperty("entity")
  private com.parrotanalytics.metrics.service.commons.constants.Entity entity;
  ...
  public PortfolioWithCount(Integer idPortfolio, String name, String description,
      ...
      Long itemCount, com.parrotanalytics.metrics.service.commons.constants.Entity entity) {
