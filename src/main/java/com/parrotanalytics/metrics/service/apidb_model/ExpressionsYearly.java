...
@Table(name = TableConstants.EXPRESSIONS_COMPUTED_YEARLY, schema = TableConstants.METRICS_SCHEMA)
public class ExpressionsYearly extends RDSBaseEntity
{
     ...
     */
    @Override
    public ExpressionsYearly clone()
    {
