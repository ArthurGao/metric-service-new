...
@Table(name = TableConstants.MOVIE_EXPRESSIONS_COMPUTED_MONTHLY, schema = TableConstants.METRICS_SCHEMA)
public class MovieExpressionsMonthly extends RDSBaseEntity
{
    private static final long serialVersionUID = -9149974452192458022L;
    ...
    @Override
    public MovieExpressionsMonthly clone()
    {
