...
public class ExpressionsComputedPK implements Serializable
{
     ...
     * 
     */
    private static final long serialVersionUID = -4419724490349076443L;
    ...
    public boolean equals(Object obj)
    {
        ...
        if (getClass() != obj.getClass())
            return false;
        ExpressionsComputedPK other = (ExpressionsComputedPK) obj;
        if (country == null)
        {
