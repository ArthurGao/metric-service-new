 ...
 */
@Entity
@IdClass(value = ExpressionsMonthlyPK.class)
@Table(name = TableConstants.TALENT_EXPRESSIONS_COMPUTED_MONTHLY, schema = TableConstants.METRICS_SCHEMA)
public class TalentExpressionsMonthly extends RDSBaseEntity
{
	private static final long serialVersionUID = -9149974452192458122L;
	...
	@Override
	public TalentExpressionsMonthly clone()
	{
